...
from utils import data_loader_precip
import time
...
if __name__ == "__main__":
    ...
    train_dl, valid_dl = data_loader_precip.get_train_valid_loader(
        data_dir=ROOT_DIR / "dataset" / "train_test_rain-threshold_0.h5",
    ...
    # Load SmaAt-UNet
    model = SmaAt_UNet(n_channels=216, n_classes=21)
